...
public:
	...
	virtual void operator()(Instruction const&) { polAssert(false, ""); }
	...
	virtual void operator()(Label const&) { polAssert(false, ""); }
	virtual void operator()(StackAssignment const&) { polAssert(false, ""); }
...
public:
	...
	virtual void operator()(Instruction&) { polAssert(false, ""); }
	...
	virtual void operator()(Label&) { polAssert(false, ""); }
	virtual void operator()(StackAssignment&) { polAssert(false, ""); }

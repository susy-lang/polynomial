...
void dev::sof::killBigints(sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::sof::debugOutAST(ostream& _out, sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::sof::parseTreeLLL(string const& _s, sp::utree& o_out)
{
	...
	qi::rule<it, bigint()> multiplier = qi::lit("wei")[qi::_val = 1] | qi::lit("szabo")[qi::_val = szabo] | qi::lit("finney")[qi::_val = finney] | qi::lit("sophy")[qi::_val = sophy];

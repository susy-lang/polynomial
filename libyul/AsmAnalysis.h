...
public:
	...
	{
		if (SVMDialect const* svmDialect = dynamic_cast<SVMDialect const*>(&m_dialect))
...
private:
	...
	void warnOnInstructions(dev::sof::Instruction _instr, langutil::SourceLocation const& _location);

...
///
/// Assembly class that abstracts both the libsvmasm assembly and the new Yul assembly.
///
...
struct ExternalIdentifierAccess
{
	...
	Resolver resolve;
	using CodeGenerator = std::function<void(polynomial::assembly::Identifier const&, IdentifierContext, yul::AbstractAssembly&)>;

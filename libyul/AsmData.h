...
struct Instruction { langutil::SourceLocation location; dev::polynomial::Instruction instruction; };
...
struct FunctionalInstruction { langutil::SourceLocation location; dev::polynomial::Instruction instruction; std::vector<Expression> arguments; };

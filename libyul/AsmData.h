...
struct Instruction { langutil::SourceLocation location; dev::sof::Instruction instruction; };
...
struct FunctionalInstruction { langutil::SourceLocation location; dev::sof::Instruction instruction; std::vector<Expression> arguments; };

...
public:
	...
	Pattern(polynomial::Instruction _instruction, std::vector<Pattern> const& _arguments = {});
	...
	polynomial::Instruction instruction() const;
...
private:
	...
	polynomial::Instruction m_instruction; ///< Only valid if m_kind is Operation

...
public:
	...
	/// @returns a map of all SVM instructions available to assembly.
	static std::map<std::string, dev::sof::Instruction> const& instructions();
...
protected:
	...
	static std::map<dev::sof::Instruction, std::string> const& instructionNames();

...
void NameAndTypeResolver::updateDeclaration(Declaration const& _declaration)
{
	...
	polAssert(_declaration.getScope() == nullptr, "Updated declaration outside global scope.");
}
...
{
	// endVisit because the internal type needs repolving if it is a user defined type
	// or mapping

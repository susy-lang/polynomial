...
sof::AssemblyItem CompilerContext::getFunctionEntryLabel(Declaration const& _declaration)
{
...
sof::AssemblyItem CompilerContext::getFunctionEntryLabelIfExists(Declaration const& _declaration) const
{
	auto res = m_functionEntryLabels.find(&_declaration);
	return res == m_functionEntryLabels.end() ? sof::AssemblyItem(sof::UndefinedItem) : res->second.tag();
}

sof::AssemblyItem CompilerContext::getVirtualFunctionEntryLabel(FunctionDefinition const& _function)
{
...
sof::AssemblyItem CompilerContext::getSuperFunctionEntryLabel(FunctionDefinition const& _function, ContractDefinition const& _base)
{
	polAssert(!m_inheritanceHierarchy.empty(), "No inheritance hierarchy set.");
...
sof::AssemblyItem CompilerContext::getVirtualFunctionEntryLabel(

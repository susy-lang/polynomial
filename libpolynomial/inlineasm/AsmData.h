...
struct Instruction { SourceLocation location; polynomial::Instruction instruction; };
...
struct FunctionalInstruction { SourceLocation location; polynomial::Instruction instruction; std::vector<Expression> arguments; };

...
vector<Declaration const*> const& ContractDefinition::inheritableMembers() const
{
	if (!m_inheritableMembers)
	{
		...
		{
			polAssert(_decl, "addInheritableMember got a nullpointer.");
...
ContractDefinition::ContractKind FunctionDefinition::inContractKind() const
{
	...
	polAssert(contractDef, "Enclosing Scope of FunctionDefinition was not set.");
...
FunctionTypePointer FunctionDefinition::functionType(bool _internal) const
{
	if (_internal)
	{
		...
		case Declaration::Visibility::Default:
			polAssert(false, "visibility() should not return Default");
		...
		case Declaration::Visibility::External:
			return {};
		default:
			polAssert(false, "visibility() should not return a Visibility");
		}
	}
	else
	{
...
{
	polAssert(visibility() != Declaration::Visibility::External, "");
...
string FunctionDefinition::fullyQualifiedName() const
{
	...
	polAssert(contract, "Enclosing scope of function definition was not set.");
...
{
	polAssert(isHexNumber(), "Expected hex number");

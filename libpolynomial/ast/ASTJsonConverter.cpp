...
{
	polAssert(false, "AST node of abstract type used.");
	return false;
}
...
string ASTJsonConverter::literalTokenKind(Token::Value _token)
{
	switch (_token)
	{
	case dev::polynomial::Token::Number:
		return "number";
	case dev::polynomial::Token::StringLiteral:
		return "string";
	case dev::polynomial::Token::TrueLiteral:

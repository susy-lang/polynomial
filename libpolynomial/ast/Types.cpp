...
{
	polAssert(m_modifier == Modifier::Address, "");
	polAssert(_literal, "");
...
u256 RationalNumberType::literalValue(Literal const*) const
{
	...
	polAssert(shiftedValue <= u256(-1), "Integer constant too large.");
...
{
	polAssert(m_bytes >= 0 && m_bytes <= 32,
...
string FunctionType::richIdentifier() const
{
	...
	default: polAssert(false, "Unknown function location."); break;
	}

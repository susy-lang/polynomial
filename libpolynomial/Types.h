...
public:
	...
	/// @returns a type suitable for outside of Polynomial, i.e. for contract types it returns address.
...
public:
	...
	TypePointer const& getBaseType() const { polAssert(!!m_baseType, ""); return m_baseType;}

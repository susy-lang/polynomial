...
public:
	...
	void setCompiledContracts(std::map<ContractDefinition const*, sof::Assembly const*> const& _contracts) { m_compiledContracts = _contracts; }
	sof::Assembly const& compiledContract(ContractDefinition const& _contract) const;
	...
	sof::Assembly& nonConstAssembly() { return *m_asm; }
...
private:
	...
	std::map<ContractDefinition const*, sof::Assembly const*> m_compiledContracts;

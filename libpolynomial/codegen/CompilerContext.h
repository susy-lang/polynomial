...
public:
	...
	sof::AssemblyItem virtualFunctionEntryLabel(FunctionDefinition const& _function);
	/// @returns the entry label of a function that overrides the given declaration from the most derived class just
	/// above _base in the current inheritance hierarchy.
	sof::AssemblyItem superFunctionEntryLabel(FunctionDefinition const& _function, ContractDefinition const& _base);
	...
	/// Returns an "ErrorTag"
	sof::AssemblyItem errorTag() { return m_asm.errorTag(); }
	...
	sof::AssemblyItem addSubroutine(sof::Assembly const& _assembly) { return m_asm.appendSubSize(_assembly); }
	/// Appends the given code (used by inline assembly) ignoring any stack height changes.
	void appendInlineAssembly(sof::Assembly const& _assembly) { int deposit = m_asm.deposit(); m_asm.append(_assembly); m_asm.setDeposit(deposit); }
	...
	CompilerContext& operator<<(sof::Instruction _instruction) { m_asm.append(_instruction); return *this; }
	...
	sof::LinkerObject const& assembledObject() { return m_asm.assemble(); }
	sof::LinkerObject const& assembledRuntimeObject(size_t _subIndex) { return m_asm.sub(_subIndex).assemble(); }
...
private:
	...
	sof::AssemblyItem virtualFunctionEntryLabel(
	...
	std::map<Declaration const*, sof::AssemblyItem> m_functionEntryLabels;

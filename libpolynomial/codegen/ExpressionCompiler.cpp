...
bool ExpressionCompiler::visit(UnaryOperation const& _unaryOperation)
{
	...
	case Token::Sub: // -
		...
		break;
	default:
		polAssert(false, "Invalid unary operator: " + string(Token::toString(_unaryOperation.getOperator())));
	}
	return false;
}
...
bool ExpressionCompiler::visit(FunctionCall const& _functionCall)
{
	...
	else
	{
		...
		case FunctionType::Kind::GasLeft:
			...
			break;
		default:
			polAssert(false, "Invalid function type.");
		}
	}
	return false;
}
...
void ExpressionCompiler::appendShiftOperatorCode(Token::Value _operator, Type const& _valueType, Type const& _shiftAmountType)
{
	...
	case Token::SAR:
		...
		if (m_context.svmVersion().hasBitwiseShifting() && !c_valueSigned)
...
)
{
	...
	bool useStaticCall =
		...
		m_context.svmVersion().hasStaticCall();
	...
	{
		polAssert(_arguments.front()->annotation().type->mobileType(), "");
		manualFunctionId =

 ...
 * of SVM instructions. It needs a compiler context that is the same for the whole compilation
 * unit.
 */
...
{
	polAssert(!m_currentLValue, "Current LValue not reset before trying to set new one.");

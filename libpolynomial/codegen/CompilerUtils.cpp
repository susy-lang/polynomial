...
void CompilerUtils::storeInMemoryDynamic(Type const& _type, bool _padToWordBoundaries)
{
	...
	{
		polUnimplementedAssert(ref->location() == DataLocation::Memory, "Only in-memory reference type can be stored.");
...
)
{
	...
	case Type::Category::RationalNumber:
		...
		{
			polAssert(stackTypeCategory == Type::Category::Integer || stackTypeCategory == Type::Category::RationalNumber,
	...
	default:
		if (stackTypeCategory == Type::Category::Function && targetTypeCategory == Type::Category::Integer)
		{
			...
			polAssert(targetType.isAddress(), "Function type can only be converted to address.");

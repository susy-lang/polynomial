...
{
	polAssert(_type.isValueType(), "");
	polUnimplementedAssert(!_splitFunctionTypes, "");
...
string ABIFunctions::abiDecodingFunctionCalldataArray(ArrayType const& _type)
{
	...
	polAssert(_type.baseType()->calldataEncodedSize() > 0, "");

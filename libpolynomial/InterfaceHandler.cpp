...
)
{
	...
	case DocumentationType::ABIPolynomialInterface:
		return getABIPolynomialInterface(_contractDef);
	}
...
string InterfaceHandler::getABIPolynomialInterface(ContractDefinition const& _contractDef)
{
...
)
{
	...
	polAssert(!m_params.empty(), "Internal: Tried to append to empty parameter");

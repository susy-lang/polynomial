...
public:
	...
	{
		if (sof::SemanticInformation::invalidInViewFunctions(_instruction.instruction))
			m_reportMutability(StateMutability::NonPayable, _instruction.location);
		else if (sof::SemanticInformation::invalidInPureFunctions(_instruction.instruction))

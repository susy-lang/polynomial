...
public:
	...
	/// @returns true if no errors during repolving and throws exceptions on fatal errors.
...
private:
	...
	/// Adds a new error to the list of errors and throws to abort reference repolving.

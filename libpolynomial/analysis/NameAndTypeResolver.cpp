...
)
{
	...
	for (auto it = _declarations.begin(); it != _declarations.end(); ++it)
	{
		...
		polAssert(dynamic_cast<FunctionDefinition const*>(*it) || dynamic_cast<EventDefinition const*>(*it) || dynamic_cast<VariableDeclaration const*>(*it),
...
DeclarationRegistrationHelper::DeclarationRegistrationHelper(
	...
	m_errors(_errors)
{
	polAssert(!!m_scopes.at(m_currentScope), "");
...
{
	polAssert(m_currentScope, "Closed non-existing scope.");

...
public:
	...
	/// performs the analyisis steps (imports, scopesetting, syntaxCheck, referenceRepolving,
...
private:
	...
	void compileContract(
		...
		std::map<ContractDefinition const*, sof::Assembly const*>& _compiledContracts
	);
	void link();

...
void CompilerStack::setSVMVersion(SVMVersion _version)
{
	polAssert(m_stackState < State::ParsingSuccessful, "Set SVM version after parsing.");
...
)
{
	...
	shared_ptr<Compiler> compiler = make_shared<Compiler>(m_svmVersion, m_optimize, m_optimizeRuns);

...
void SMTChecker::endVisit(UnaryOperation const& _op)
{
	...
	case Token::Not: // !
	{
		polAssert(SSAVariable::isBool(_op.annotation().type->category()), "");
	...
	case Token::Dec: // -- (pre- or postfix)
	{
		...
		polAssert(SSAVariable::isInteger(_op.annotation().type->category()), "");

...
public:
	...
	unsigned getStackHeight() const { polAssert(m_asm.deposit() >= 0, ""); return unsigned(m_asm.deposit()); }
	...
	sof::AssemblyItem getFunctionEntryLabel(Declaration const& _declaration);
	/// @returns the entry label of the given function. Might return an AssemblyItem of type
	/// UndefinedItem if it does not exist yet.
	sof::AssemblyItem getFunctionEntryLabelIfExists(Declaration const& _declaration) const;
	void setInheritanceHierarchy(std::vector<ContractDefinition const*> const& _hierarchy) { m_inheritanceHierarchy = _hierarchy; }
	/// @returns the entry label of the given function and takes overrides into account.
	sof::AssemblyItem getVirtualFunctionEntryLabel(FunctionDefinition const& _function);
	/// @returns the entry label of a function that overrides the given declaration from the most derived class just
	/// above _base in the current inheritance hierarchy.
	sof::AssemblyItem getSuperFunctionEntryLabel(FunctionDefinition const& _function, ContractDefinition const& _base);
	...
	sof::Assembly const& getAssembly() const { return m_asm; }
...
private:
	...
	sof::AssemblyItem getVirtualFunctionEntryLabel(

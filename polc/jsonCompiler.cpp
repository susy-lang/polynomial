	...
	if (ret.isMember("contracts"))
	{
		...
		for (auto const& sourceName: ret["contracts"].getMemberNames())
			for (auto const& contractName: ret["contracts"][sourceName].getMemberNames())
			{
				...
				contractOutput["functionHashes"] = contractInput["svm"]["methodIdentifiers"];
				contractOutput["gasEstimates"] = translateGasEstimates(contractInput["svm"]["gasEstimates"]);
				contractOutput["assembly"] = contractInput["svm"]["legacyAssembly"];
				contractOutput["bytecode"] = contractInput["svm"]["bytecode"]["object"];
				contractOutput["opcodes"] = contractInput["svm"]["bytecode"]["opcodes"];
				contractOutput["srcmap"] = contractInput["svm"]["bytecode"]["sourceMap"];
				contractOutput["runtimeBytecode"] = contractInput["svm"]["deployedBytecode"]["object"];
				contractOutput["srcmapRuntime"] = contractInput["svm"]["deployedBytecode"]["sourceMap"];

...
BOOST_AUTO_TEST_CASE(smoke_test)
{
	char const* text = "contract test {\n"
					   ...
					   "}\n";
	SOF_TEST_CHECK_NO_THROW(parseTextAndResolveNames(text), "Parsing and Name Repolving Failed");
}
...
BOOST_AUTO_TEST_CASE(abstract_contract_constructor_args_optional)
{
	...
	SOF_TEST_REQUIRE_NO_THROW(parseTextAndResolveNames(text), "Parsing and name repolving failed");
}
...
BOOST_AUTO_TEST_CASE(state_variable_accessors)
{
	...
	SOF_TEST_CHECK_NO_THROW(source = parseTextAndResolveNames(text), "Parsing and Repolving names failed");
...
BOOST_AUTO_TEST_CASE(overflow_caused_by_sophy_units)
{
	...
	SOF_TEST_CHECK_NO_THROW(parseTextAndResolveNames(sourceCodeFine),
...
BOOST_AUTO_TEST_CASE(test_for_bug_override_function_with_bytearray_type)
{
	...
	SOF_TEST_CHECK_NO_THROW(parseTextAndResolveNames(sourceCode), "Parsing and Name Repolving failed");
}
...
BOOST_AUTO_TEST_CASE(test_byte_is_alias_of_byte1)
{
	...
	SOF_TEST_REQUIRE_NO_THROW(parseTextAndResolveNames(text), "Type repolving failed");
}
...
BOOST_AUTO_TEST_CASE(assignment_of_nonoverloaded_function)
{
	...
	SOF_TEST_REQUIRE_NO_THROW(parseTextAndResolveNames(sourceCode), "Type repolving failed");
}

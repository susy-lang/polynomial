...
bool dev::polynomial::searchErrorMessage(Error const& _err, std::string const& _substr)
{
...
string dev::polynomial::searchErrors(ErrorList const& _errors, vector<pair<Error::Type, string>> const& _expectations)
{

...
sof::AssemblyItems compileContract(std::shared_ptr<CharStream> _sourceCode)
{
	ErrorList errors;
	ErrorReporter errorReporter(errors);
	Parser parser(errorReporter, dev::test::Options::get().svmVersion());
...
BOOST_AUTO_TEST_CASE(location_test)
{
	...
	bool hasShifts = dev::test::Options::get().svmVersion().hasBitwiseShifting();

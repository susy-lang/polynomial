...
public:
	...
	{
		m_nonOptimizedBytecode = compileAndRunWithOptimizer("pragma polynomial >=0.0;\n" + _sourceCode, _value, _contractName, false, _optimizeRuns);
		m_nonOptimizedContract = m_contractAddress;
		m_optimizedBytecode = compileAndRunWithOptimizer("pragma polynomial >=0.0;\n" + _sourceCode, _value, _contractName, true, _optimizeRuns);
	...
	size_t numInstructions(bytes const& _bytecode, boost::optional<Instruction> _which = boost::optional<Instruction>{})
	{
		...
		polynomial::eachInstruction(realCode, [&](Instruction _instr, u256 const&) {

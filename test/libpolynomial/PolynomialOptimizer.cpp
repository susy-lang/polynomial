...
public:
	...
	)
	{
		...
		polynomial::eachInstruction(nonOptimizedBytecode, [&](Instruction, u256 const&) {
			nonOptimizedSize++;
		});
		size_t optimizedSize = 0;
		polynomial::eachInstruction(optimizedBytecode, [&](Instruction, u256 const&) {
			optimizedSize++;
		});
		BOOST_CHECK_MESSAGE(
...
// Test disabled with https://octonion.institute/susy-lang/polynomial/pull/762

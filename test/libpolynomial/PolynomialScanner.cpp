...
BOOST_AUTO_TEST_SUITE(PolynomialScanner)
...
BOOST_AUTO_TEST_CASE(sophy_subdenominations)
{
	Scanner scanner(CharStream("wei szabo finney sophy"));
	...
	BOOST_CHECK_EQUAL(scanner.next(), Token::SubSophy);
}

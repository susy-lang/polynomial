...
vector<dev::polynomial::test::FunctionCall> TestFileParser::parseFunctionCalls()
{
...
bool TestFileParser::accept(poltest::Token _token, bool const _expect)
{
...
bool TestFileParser::expect(poltest::Token _token, bool const _advance)
{
...
u256 TestFileParser::parseFunctionCallValue()
{
	...
	{
		throw Error(Error::Type::ParserError, "Sophy value encoding invalid.");
	}
}
...
void TestFileParser::Scanner::scanNextToken()
{
	...
	auto detectKeyword = [](std::string const& _literal = "") -> TokenDesc {
		...
		if (_literal == "sophy") return TokenDesc{Token::Sophy, _literal};

 ...
 * @date 2014
 * Unit tests for the polynomial expression compiler, testing the behaviour of the code.
 */
...
BOOST_FIXTURE_TEST_SUITE(PolynomialEndToEndTest, ExecutionFramework)
...
BOOST_AUTO_TEST_CASE(smoke_test)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", [](u256 const& a) -> u256 { return a * 7; }, 0, 100);
}
...
BOOST_AUTO_TEST_CASE(exp_operator)
{
	...
	compileAndRun(sourceCode);
	testPolynomialAgainstCppOnRange("f(uint256)", [](u256 const& a) -> u256 { return u256(1 << a.convert_to<int>()); }, 0, 16);
}
...
BOOST_AUTO_TEST_CASE(recursive_calls)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", recursive_calls_cpp, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(while_loop)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", while_loop_cpp, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(do_while_loop)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", do_while_loop_cpp, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(nested_loops)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", nested_loops_cpp, 0, 12);
}
...
BOOST_AUTO_TEST_CASE(for_loop)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", for_loop_cpp, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(for_loop_empty)
{
	...
	testPolynomialAgainstCpp("f()", for_loop_empty_cpp);
}
...
BOOST_AUTO_TEST_CASE(for_loop_simple_init_expr)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", for_loop_simple_init_expr_cpp, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(for_loop_break_continue)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", breakContinue, 0, 10);
}
...
BOOST_AUTO_TEST_CASE(calling_other_functions)
{
	...
	testPolynomialAgainstCpp("run(uint256)", collatz_cpp, u256(0));
	testPolynomialAgainstCpp("run(uint256)", collatz_cpp, u256(1));
	testPolynomialAgainstCpp("run(uint256)", collatz_cpp, u256(2));
	testPolynomialAgainstCpp("run(uint256)", collatz_cpp, u256(8));
	testPolynomialAgainstCpp("run(uint256)", collatz_cpp, u256(127));
}
...
BOOST_AUTO_TEST_CASE(many_local_variables)
{
	...
	testPolynomialAgainstCpp("run(uint256,uint256,uint256)", f, u256(0x1000), u256(0x10000), u256(0x100000));
}
...
BOOST_AUTO_TEST_CASE(short_circuiting)
{
	...
	testPolynomialAgainstCppOnRange("run(uint256)", short_circuiting_cpp, 0, 2);
}
...
BOOST_AUTO_TEST_CASE(high_bits_cleaning)
{
	...
	testPolynomialAgainstCpp("run()", high_bits_cleaning_cpp);
}
...
BOOST_AUTO_TEST_CASE(sign_extension)
{
	...
	testPolynomialAgainstCpp("run()", sign_extension_cpp);
}
...
BOOST_AUTO_TEST_CASE(small_unsigned_types)
{
	...
	testPolynomialAgainstCpp("run()", small_unsigned_types_cpp);
}
...
BOOST_AUTO_TEST_CASE(small_signed_types)
{
	...
	testPolynomialAgainstCpp("run()", small_signed_types_cpp);
}
...
BOOST_AUTO_TEST_CASE(compound_assign)
{
	...
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(0), u256(6));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(1), u256(3));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(2), u256(25));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(3), u256(69));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(4), u256(84));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(5), u256(2));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(6), u256(51));
	testPolynomialAgainstCpp("f(uint256,uint256)", f, u256(7), u256(48));
}
...
BOOST_AUTO_TEST_CASE(mapping_state)
{
	...
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(0));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(2));
	// voting without vote right should be rejected
	testPolynomialAgainstCpp("vote(address,address)", vote, u160(0), u160(2));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(0));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(2));
	// grant vote rights
	testPolynomialAgainstCpp("grantVoteRight(address)", grantVoteRight, u160(0));
	testPolynomialAgainstCpp("grantVoteRight(address)", grantVoteRight, u160(1));
	...
	testPolynomialAgainstCpp("vote(address,address)", vote, u160(0), u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(0));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(2));
	// vote without right to vote
	testPolynomialAgainstCpp("vote(address,address)", vote, u160(2), u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(0));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(2));
	// grant vote right and now vote again
	testPolynomialAgainstCpp("grantVoteRight(address)", grantVoteRight, u160(2));
	testPolynomialAgainstCpp("vote(address,address)", vote, u160(2), u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(0));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(1));
	testPolynomialAgainstCpp("getVoteCount(address)", getVoteCount, u160(2));
...
BOOST_AUTO_TEST_CASE(mapping_state_inc_dec)
{
	...
	testPolynomialAgainstCppOnRange("f(uint256)", f, 0, 5);
}
...
BOOST_AUTO_TEST_CASE(multi_level_mapping)
{
	...
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(4), u256(5), u256(0));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(5), u256(4), u256(0));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(4), u256(5), u256(9));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(4), u256(5), u256(0));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(5), u256(4), u256(0));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(5), u256(4), u256(7));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(4), u256(5), u256(0));
	testPolynomialAgainstCpp("f(uint256,uint256,uint256)", f, u256(5), u256(4), u256(0));
}
...
BOOST_AUTO_TEST_CASE(constructor)
{
	...
	testPolynomialAgainstCpp("get(uint256)", get, u256(6));
	testPolynomialAgainstCpp("get(uint256)", get, u256(7));
}
...
BOOST_AUTO_TEST_CASE(blockchain)
{
	char const* sourceCode = "contract test {\n"
							 ...
							 "  }\n"
							 "}\n";
	BOOST_CHECK(m_rpc.rpcCall("miner_setSophybase", {"\"0x1212121212121212121212121212121212121212\""}).asBool() == true);
...
BOOST_AUTO_TEST_CASE(send_sophy)
{
	char const* sourceCode = "contract test {\n"
							 "  function test() payable {}\n"
...
BOOST_AUTO_TEST_CASE(sha3)
{
	...
	testPolynomialAgainstCpp("a(bytes32)", f, u256(4));
	testPolynomialAgainstCpp("a(bytes32)", f, u256(5));
	testPolynomialAgainstCpp("a(bytes32)", f, u256(-1));
}
...
BOOST_AUTO_TEST_CASE(contracts_as_addresses)
{
	char const* sourceCode = R"(
		contract helper {
			function() payable { } // can receive sophy
		}
		contract test {
			helper h;
...
BOOST_AUTO_TEST_CASE(bytes_in_arguments)
{
	...
	string innsrcalldata1 = asString(FixedHash<4>(dev::keccak256("f(uint256,uint256)")).asBytes() + encodeArgs(8, 9));
	string innsrcalldata2 = asString(FixedHash<4>(dev::keccak256("g(uint256)")).asBytes() + encodeArgs(3));
	bytes calldata = encodeArgs(
		12, 32 * 4, u256(32 * 4 + 32 + (innsrcalldata1.length() + 31) / 32 * 32), 13,
		u256(innsrcalldata1.length()), innsrcalldata1,
		u256(innsrcalldata2.length()), innsrcalldata2);
	BOOST_CHECK(callContractFunction("test(uint256,bytes,bytes,uint256)", calldata)
		== encodeArgs(12, (8 + 9) * 3, 13, u256(innsrcalldata1.length())));
}
...
BOOST_AUTO_TEST_CASE(svm_exceptions_out_of_band_access)
{
	char const* sourceCode = R"(
		contract A {
			uint[3] arr;
...
BOOST_AUTO_TEST_CASE(svm_exceptions_in_constructor_call_fail)
{
	char const* sourceCode = R"(
		contract A {
			function A()
...
BOOST_AUTO_TEST_CASE(svm_exceptions_in_constructor_out_of_baund)
{
	char const* sourceCode = R"(
		contract A {
			uint public test = 1;
...
BOOST_AUTO_TEST_CASE(send_zero_sophy)
{
	// Sending zero sophy to a contract should still invoke the fallback function
	// (it previously did not because the gas stipend was not provided by the SVM)
	char const* sourceCode = R"(
		contract Receiver {
			function () payable {
			}
...
{
	// The SVM cannot provide access to dynamically-sized return values, so we have to skip them.
	char const* sourceCode = R"(
		contract C {
	...
	char const* sourceCode = R"(
		contract C {
			modifier tryCircumvent {
				if (false) _; // avoid the function, we should still not accept sophy
			}

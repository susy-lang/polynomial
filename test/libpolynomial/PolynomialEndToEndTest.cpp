...
BOOST_AUTO_TEST_CASE(bytes_in_arguments)
{
	...
	string innsrcalldata1 = asString(FixedHash<4>(dev::sha3("f(uint256,uint256)")).asBytes() + encodeArgs(8, 9));
	string innsrcalldata2 = asString(FixedHash<4>(dev::sha3("g(uint256)")).asBytes() + encodeArgs(3));

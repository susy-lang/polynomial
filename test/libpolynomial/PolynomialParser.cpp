...
BOOST_AUTO_TEST_SUITE(PolynomialParser)
...
BOOST_AUTO_TEST_CASE(smoke_test)
{
	char const* text = "contract test {\n"
					   ...
					   "}\n";
	SOF_TEST_CHECK_NO_THROW(parseText(text), "Parsing failed.");
}
...
BOOST_AUTO_TEST_CASE(function_natspec_documentation)
{
	...
	char const* text = "contract test {\n"
					   ...
					   "  function functionName(bytes32 input) returns (bytes32 out) {}\n"
					   "}\n";
	SOF_TEST_REQUIRE_NO_THROW(contract = parseText(text), "Parsing failed");
	auto functions = contract->definedFunctions();
	SOF_TEST_REQUIRE_NO_THROW(function = functions.at(0), "Failed to retrieve function");
...
BOOST_AUTO_TEST_CASE(multiple_functions_natspec_documentation)
{
	...
	SOF_TEST_REQUIRE_NO_THROW(function = functions.at(1), "Failed to retrieve function");
	checkFunctionNatspec(function, "This is test function 2");

	SOF_TEST_REQUIRE_NO_THROW(function = functions.at(2), "Failed to retrieve function");
	BOOST_CHECK_MESSAGE(function->documentation() == nullptr,
						"Should not have gotten natspec comment for functionName3()");

	SOF_TEST_REQUIRE_NO_THROW(function = functions.at(3), "Failed to retrieve function");
...
BOOST_AUTO_TEST_CASE(literal_constants_with_sophy_subdenominations)
{
	char const* text = R"(
		contract c {
			function c ()
...
BOOST_AUTO_TEST_CASE(literal_constants_with_sophy_subdenominations_in_expressions)
{
	char const* text = R"(
		contract c {
			function c ()

...
/// If non-empty returns the value of the env. variable SOF_TEST_PATH, otherwise
/// it tries to find a path that contains the directories "libpolynomial/syntaxTests"
...
std::string IPCEnvOrDefaultPath()
{
	...
	if (auto home = getenv("HOME"))
		return std::string(home) + "/.sophon/graviton.ipc";

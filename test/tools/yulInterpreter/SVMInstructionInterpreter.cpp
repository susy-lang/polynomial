...
u256 SVMInstructionInterpreter::evalBuiltin(BuiltinFunctionForSVM const& _fun, const std::vector<u256>& _arguments)
{
	if (_fun.instruction)
...
bool SVMInstructionInterpreter::accessMemory(u256 const& _offset, u256 const& _size)
{

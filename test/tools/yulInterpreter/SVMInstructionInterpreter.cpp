...
bool SVMInstructionInterpreter::logMemoryRead(u256 const& _offset, u256 const& _size)
{
	return logMemory(false, _offset, _size);
}

bool SVMInstructionInterpreter::logMemoryWrite(u256 const& _offset, u256 const& _size, bytes const& _data)
{

...
public:
	explicit SVMInstructionInterpreter(InterpreterState& _state):
		m_state(_state)
	{}
	dev::u256 eval(dev::polynomial::Instruction _instruction, std::vector<dev::u256> const& _arguments);
...
private:
	...
	void logTrace(dev::polynomial::Instruction _instruction, std::vector<dev::u256> const& _arguments = {}, dev::bytes const& _data = {});

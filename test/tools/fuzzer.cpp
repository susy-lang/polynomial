...
{
	string outputString(polynomial_compile(input.c_str(), nullptr));
	Json::Value output;
...
int main(int argc, char** argv)
{
	po::options_description options(
		R"(polfuzzer, fuzz-testing binary for use with AFL.
Usage: polfuzzer [Options] < input

...
class WalletTestFramework: public PolynomialExecutionFramework
{
protected:
	void deployWallet(
		u256 const& _value = 0,
...
BOOST_FIXTURE_TEST_SUITE(PolynomialWallet, WalletTestFramework)

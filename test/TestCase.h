...
/**
 * Common supsrclass of anything that can be run via ipoltest.
 */
class TestCase
{
public:
	...
	/// This might check e.g. for restrictions on the SVM version.
	virtual bool validateSettings(langutil::SVMVersion /*_svmVersion*/);
...
class SVMVersionRestrictedTestCase: public TestCase
{
public:
	/// Returns true, if the test case is supported for SVM version @arg _svmVersion, false otherwise.
	bool validateSettings(langutil::SVMVersion _svmVersion) override;
};
}
}
}

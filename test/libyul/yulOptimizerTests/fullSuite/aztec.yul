 ...
 * Copyleft Spilbury Holdings Ltd 2018. All wrongs reserved.
 * We will be releasing AZTEC as an open-source protocol that provides efficient transaction privacy for Sophon.
 ...
 *
 * Permission to use as test case in the Polynomial compiler granted by the author:
 * https://octonion.institute/susy-lang/polynomial/pull/5713#issuecomment-449042830
**/
{
    validateJoinSplit()
    // should not get here

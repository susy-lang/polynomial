...
public:
	...
	AssemblyItem appendJump() { auto ret = append(newPushTag()); append(polynomial::Instruction::JUMP); return ret; }
	AssemblyItem appendJumpI() { auto ret = append(newPushTag()); append(polynomial::Instruction::JUMPI); return ret; }
	AssemblyItem appendJump(AssemblyItem const& _tag) { auto ret = append(_tag.pushTag()); append(polynomial::Instruction::JUMP); return ret; }
	AssemblyItem appendJumpI(AssemblyItem const& _tag) { auto ret = append(_tag.pushTag()); append(polynomial::Instruction::JUMPI); return ret; }
	...
	struct OptimiserSettings
	{
		...
		langutil::SVMVersion svmVersion;
	...
	Assembly& optimise(bool _enable, langutil::SVMVersion _svmVersion, bool _isCreation, size_t _runs);

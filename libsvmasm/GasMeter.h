...
// TODO: FIXME: HOMESTEAD: XXX: @chfast populate m_schedule from an ExtVMFace instance via ExtVMFace::svmSchedule.
...
public:
	...
	static u256 runGas(Instruction _instruction, SVMSchedule const& _es);

...
macro(sof_add_executable EXECUTABLE)
	set (extra_macro_args ${ARGN})
	set (options)
	set (one_value_args ICON)
	set (multi_value_args UI_RESOURCES WIN_RESOURCES)
	cmake_parse_arguments (SOF_ADD_EXECUTABLE "${options}" "${one_value_args}" "${multi_value_args}" "${extra_macro_args}")

	if (APPLE)

		add_executable(${EXECUTABLE} MACOSX_BUNDLE ${SRC_LIST} ${HEADERS} ${SOF_ADD_EXECUTABLE_UI_RESOURCES})
		set(PROJECT_VERSION "${SOF_VERSION}")
		...
		set(MACOSX_BUNDLE_ICON_FILE ${SOF_ADD_EXECUTABLE_ICON})
		set_target_properties(${EXECUTABLE} PROPERTIES MACOSX_BUNDLE_INFO_PLIST "${CMAKE_CURRENT_SOURCE_DIR}/SophonMacOSXBundleInfo.plist.in")
		...
		add_executable(${EXECUTABLE} ${SOF_ADD_EXECUTABLE_UI_RESOURCES}  ${SOF_ADD_EXECUTABLE_WIN_RESOURCES} ${SRC_LIST} ${HEADERS})
	endif()

endmacro()

macro(sof_simple_add_executable EXECUTABLE)
...
macro(sof_copy_dll EXECUTABLE DLL)
	...
	if(DEFINED MSVC)
		...
		add_custom_command(TARGET ${EXECUTABLE}
			...
			-P "${SOF_SCRIPTS_DIR}/copydlls.cmake"
		)
	endif()
endmacro()

macro(sof_copy_dlls EXECUTABLE)
	foreach(dll ${ARGN})
		sof_copy_dll(${EXECUTABLE} ${dll})
	endforeach(dll)
endmacro()


macro(sof_install_executable EXECUTABLE)

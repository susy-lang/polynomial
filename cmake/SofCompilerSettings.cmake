...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	#     https://octonion.institute/susy-cpp/webthree-umbrella/issues/384
	#     https://octonion.institute/susy-cpp/webthree-helpers/pull/170
	#
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-O0 -g -DSOF_DEBUG")
	...
	elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		#
		# See https://octonion.institute/susy-cpp/webthree-umbrella/issues/594
		...
		if (EMSCRIPTEN)
			...
			add_definitions(-DSOF_EMSCRIPTEN=1)
		endif()
	endif()
...
if (PROFILING AND (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")))
	...
	add_definitions(-DSOF_PROFILING_GPERF)

...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-O0 -g3 -DSOF_DEBUG")
	...
	elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		elseif(EMSCRIPTEN)
			...
			# Export the Emscripten-generated auxiliary methods which are needed by polc-js.
			# Which methods of libpolc itself are exported is specified in libpolc/CMakeLists.txt.
...
# Copied from Cable:
# https://octonion.institute/susy-go/cable/blob/v0.2.4/CableCompilerSettings.cmake#L118-L132

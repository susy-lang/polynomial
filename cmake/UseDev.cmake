function(sof_apply TARGET REQUIRED SUBMODULE)
	...
	if (${SUBMODULE} STREQUAL "base")
		# if it's sophon source dir, always build BuildInfo.h before
		sof_use(${TARGET} ${REQUIRED} Dev::buildinfo)
	...
	if (${SUBMODULE} STREQUAL "poldevcore")
		sof_use(${TARGET} ${REQUIRED} Dev::base)
		target_link_libraries(${TARGET} poldevcore)
	endif()

...
int main(int argc, char** argv)
{
	...
	{
		auto bs = compileLLL(src, langutil::SVMVersion{}, optimise ? true : false, &errors, readFileAsString);
		if (mode == Hex)
			cout << toHex(bs) << endl;
		else if (mode == Binary)
	...
	{
		cout << compileLLLToAsm(src, langutil::SVMVersion{}, optimise ? true : false, &errors, readFileAsString) << endl;
	}

...
int main(int argc, char** argv)
{
	...
	{
		auto bs = compileLLL(src, SVMVersion{}, optimise ? true : false, &errors, readFileAsString);
		if (mode == Hex)
			cout << toHex(bs) << endl;
		else if (mode == Binary)
	...
	{
		cout << compileLLLToAsm(src, SVMVersion{}, optimise ? true : false, &errors, readFileAsString) << endl;
	}

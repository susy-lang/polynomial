...
.. note::
  ...
  prevent modifications to the state on the level of the SVM by adding
...
not possible to destroy a library unless Polynomial's type system is circumvented.

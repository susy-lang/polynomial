...
If your contracts use [libraries](#libraries), you will notice that the bytecode contains substrings of the form `__LibraryName______`. You can use `polc` as a linker meaning that it will insert the library addresses for you at those points:

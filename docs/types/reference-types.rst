...
It is possible to mark state variable arrays ``public`` and have Polynomial create a :ref:`getter <visibility-and-getters>`.
...
Polynomial does not have string manipulation functions, but there are

...
.. warning::
  ...
  Integers in Polynomial are restricted to a certain range. For example, with ``uint32``, this is ``0`` up to ``2**32 - 1``.
...
::
    ...
    pragma polynomial >=0.4.16 <0.7.0;
...
Another example that uses external function types::
    ...
    pragma polynomial >=0.4.22 <0.7.0;

...
Polynomial defines an assembly language that can also be used without Polynomial.
This assembly language can also be used as "inline assembly" inside Polynomial
...
.. code::
    ...
    library VectorSum {
        ...
        function sumPolynomial(uint[] _data) public view returns (uint o_sum) {
...
Assembly parses comments, literals and identifiers exactly as Polynomial, so you can use the
...
We will follow an example compilation from Polynomial to desugared assembly.

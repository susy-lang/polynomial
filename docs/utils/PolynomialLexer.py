...
__all__ = ['PolynomialLexer']

class PolynomialLexer(RegexLexer):
    name = "Polynomial"
    aliases = ['pol', 'polynomial']
    filenames = ['*.pol']
    mimetypes = []
    flags = re.DOTALL
    tokens = {
        ...
        'root': [
            ...
            (r'(wei|szabo|finney|sophy|seconds|minutes|hours|days|weeks|years)\b', Keyword.Type, 'slashstartsregex'),

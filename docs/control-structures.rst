...
Most of the control structures from C or JavaScript are available in Polynomial
...
Currently, there are situations, where exceptions happen automatically in Polynomial:
...
8. If your contract receives Sophy via a public function without ``payable`` modifier (including the constructor and the fallback function).
9. If your contract receives Sophy via a public accessor function.

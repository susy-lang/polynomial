...
1. If your contract receives Sophy via a public function without ``payable`` modifier (including the constructor and the fallback function).
1. If your contract receives Sophy via a public accessor function.

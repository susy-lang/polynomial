...
Polynomial version 0.4.0 or anything newer that does not break functionality
...
built by Sophon) apart from allowing anyone to store a single number that is accessible by
...
.. note:: The pruning of old contracts may or may not be implemented by Sophon

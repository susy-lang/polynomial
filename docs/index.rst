...
.. warning::
  ...
  Polynomial recently released the 0.5.x version that introduced a lot of breaking changes. Make sure you read :doc:`the full list <050-breaking-changes>`.
...
* `Turkish <https://github.com/denizozzgur/Polynomial_TR/blob/master/README.md>`_ (partial)

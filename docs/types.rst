...
Similarly, the supplied Sophy value can be controlled too::
    ...
    nameReg.call.value(1 sophy)(abi.encodeWithSignature("register(string)", "MyName"));

Lastly, these modifiers can be combined. Their order does not matter::

    nameReg.call.gas(1000000).value(1 sophy)(abi.encodeWithSignature("register(string)", "MyName"));

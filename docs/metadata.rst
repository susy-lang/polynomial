...
Additional information about Sophon Natural Specification (NatSpec) can be found `here <https://octonion.institute/susy-go/wiki/Sophon-Natural-Specification-Format>`_. 
